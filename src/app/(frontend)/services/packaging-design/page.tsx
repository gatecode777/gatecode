        ...
        <div className="dm-why-choose-layout">
          ...
          <div className="dm-why-choose-image">
            <Image
              ...
              alt="Product Labeling and Packaging Box Layout Mockup - Gatecode Technologies"
      ...
      <div className="dm-container">
        <div className="dm-industries-layout">
          ...
          <div className="dm-image-grid">
            <Image src="/images/1.webp" alt="Food and Beverage Bottle and Box Designs - Gatecode Technologies" className="dm-industry-img-1" width={200} height={150} />
            <Image src="/images/2.webp" alt="Cosmetics and Personal Care Packaging Designs - Gatecode Technologies" className="dm-industry-img-2" width={200} height={150} />
            <Image src="/images/3.webp" alt="E-Commerce Store Shipping Box Designs - Gatecode Technologies" className="dm-industry-img-3" width={200} height={150} />
            <Image src="/images/4.webp" alt="Healthcare and Medical Product Label Designs - Gatecode Technologies" className="dm-industry-img-4" width={200} height={150} />
            <Image src="/images/5.webp" alt="FMCG Goods Commercial Packaging Designs - Gatecode Technologies" className="dm-industry-img-5" width={200} height={150} />
          </div>
        </div>
      </div>
    </section>
