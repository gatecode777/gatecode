      ...
      <div className="dm-container">
        <div className="dm-industries-layout">
          ...
          <div className="dm-image-grid">
            <Image src="/images/1.jpg" alt="E-Commerce Data Entry and Processing - Gatecode Technologies" className="dm-industry-img-1" width={200} height={150} />
            <Image src="/images/2.jpg" alt="Healthcare Patient Records and Document Management - Gatecode Technologies" className="dm-industry-img-2" width={200} height={150} />
            <Image src="/images/3.jpg" alt="Financial and Bookkeeping Back Office Support - Gatecode Technologies" className="dm-industry-img-3" width={200} height={150} />
            <Image src="/images/4.jpg" alt="Education and Training Records Database Management - Gatecode Technologies" className="dm-industry-img-4" width={200} height={150} />
            <Image src="/images/5.jpg" alt="Real Estate Listing and Document Digitization - Gatecode Technologies" className="dm-industry-img-5" width={200} height={150} />
          </div>
        </div>
      </div>
    </section>
