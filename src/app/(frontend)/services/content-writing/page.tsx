  ...
  return (
    <section className="dm-hero">
      <div
        ...
        style={{ backgroundImage: `url('/images/Rectangle 228 (15).png')` }}
      />
      ...
      <div className="dm-container">
        <div className="dm-industries-layout">
          ...
          <div className="dm-image-grid">
            ...
            <Image src="/images/2.jpg" alt="Restaurant and Hospitality Blog Post Copywriting - Gatecode Technologies" className="dm-industry-img-2" width={200} height={150} />
            <Image src="/images/3.jpg" alt="Healthcare and Medical Content Copywriting - Gatecode Technologies" className="dm-industry-img-3" width={200} height={150} />
            <Image src="/images/4.jpg" alt="Educational School E-Learning Material Writing - Gatecode Technologies" className="dm-industry-img-4" width={200} height={150} />
            <Image src="/images/5.jpg" alt="Real Estate Brokerage Listings Copywriting - Gatecode Technologies" className="dm-industry-img-5" width={200} height={150} />
          </div>
        </div>
      </div>
    </section>
