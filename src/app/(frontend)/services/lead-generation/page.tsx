      ...
      <div className="dm-container">
        <div className="dm-industries-layout">
          ...
          <div className="dm-image-grid">
            <Image src="/images/1.jpg" alt="E-Commerce Store Customer Acquisition and Lead Generation - Gatecode Technologies" className="dm-industry-img-1" width={200} height={150} />
            <Image src="/images/2.jpg" alt="Real Estate Property Lead Campaigns - Gatecode Technologies" className="dm-industry-img-2" width={200} height={150} />
            <Image src="/images/3.jpg" alt="Healthcare Patient Appointment Leads - Gatecode Technologies" className="dm-industry-img-3" width={200} height={150} />
            <Image src="/images/4.jpg" alt="Educational Course Student Admissions Leads - Gatecode Technologies" className="dm-industry-img-4" width={200} height={150} />
            <Image src="/images/5.jpg" alt="Restaurant Catering Lead Generation - Gatecode Technologies" className="dm-industry-img-5" width={200} height={150} />
          </div>
        </div>
      </div>
    </section>
